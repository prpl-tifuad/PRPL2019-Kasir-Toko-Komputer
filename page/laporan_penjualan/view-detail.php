                        ...
                        <div class="body">
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                    ...
                                    <tr>
                                        <th colspan="3" style="text-align: center; font-weight: bold;">Jumlah Keuntungan</th>
                                        <td align="left" style="font-weight: bold; font-size: 20px;"><?php  echo "Rp. ".number_format($total);?></td>
                                    </tr>
                                </table>
